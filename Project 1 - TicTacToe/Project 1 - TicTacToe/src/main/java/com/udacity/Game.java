...
//        String row1 = ""+grid[0][0]+grid[1][0]+grid[2][0];
//        String row2 = ""+grid[0][1]+grid[1][1]+grid[2][1];
//        String row3 = ""+grid[0][2]+grid[1][2]+grid[2][2];
//        String col1 = ""+grid[0][0]+grid[0][1]+grid[0][2];
//        String col2 = ""+grid[1][0]+grid[1][1]+grid[1][2];
//        String col3 = ""+grid[2][0]+grid[2][1]+grid[2][2];
...
//            result = "X wins";
        // NIE DZIAŁAJĄ PĘTLE
//        for (int xgrid0 = 0; xgrid0 <=2; xgrid0++){
//            if (grid[xgrid0][0] == '-'){
//                result = "None";}
//            for (int xgrid1 = 0; xgrid1 <=2; xgrid1++){
//                if (grid[xgrid1][1] == '-'){
//                    result = "None";}
//                for (int xgrid2 = 0; xgrid2 <=2; xgrid2++){
//                    if (grid[xgrid2][2] == '-'){
//                        result = "None";}
        ...
        if ((grid[0][0] == 'x' && grid[1][0] == 'x') && grid[2][0] == 'x') {
            ...
            result = "O wins";}
        else if (grid[0][0] == '-'){result = "None";}
        else if (grid[1][0] == '-'){result = "None";}
        else if (grid[2][0] == '-'){result = "None";}
        else if (grid[0][1] == '-'){result = "None";}
        else if (grid[1][1] == '-'){result = "None";}
        else if (grid[2][1] == '-'){result = "None";}
        else if (grid[0][2] == '-'){result = "None";}
        else if (grid[1][2] == '-'){result = "None";}
        else if (grid[2][2] == '-'){result = "None";}
